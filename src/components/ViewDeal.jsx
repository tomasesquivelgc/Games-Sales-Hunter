        ...
        <>
          ...
          <ul className="pageBody">
            <li>
              ...
              <p>
                $
                {dealData.gameInfo.retailPrice}
              </p>
            </li>
            <li>
              <p>STEAM RATING:</p>
              <p>{dealData.gameInfo.steamRatingText}</p>
            </li>
            <li>
              <p>NUMBER OF REVIEWS:</p>
              <p>{dealData.gameInfo.steamRatingCount}</p>
            </li>
            <li>
            ...
            <li>
              <p>RELEASE DATE:</p>
              <p>{dateInfo.toLocaleDateString()}</p>
            </li>
            <li>
              <p>STEAM APP ID:</p>
              <p>{dealData.gameInfo.steamAppID}</p>
            </li>
            <li>
